export const MODULE_REC: string = 'SRP';
...
export const PATH_ADMIN_CONSOLE = 'admin-console';
export const PATH_MANAGE_ACC = 'manage-account';
export const PATH_REC = 'rec';
export const PATH_PAL = 'pal';
export const PATH_SCI = 'sci';
...
export const URL_AUTHENTICATE = 'api/auth/login';
...
export const CONFIRM_DEFAULT_CONFIRM_TEXT = 'Continue';
export const CONFIRM_DEFAULT_ICON = 'error_outline'; // warning
export const CONFIRM_QUESTION_ICON = 'help_outline'; // question
export const CONFIRM_SUCCESS_ICON = 'task_alt';
export const CONFIRM_DEFAULT_TEXT = 'Are you sure you want to continue?';
export const CONFIRM_DEFAULT_TITLE = 'Confirm or Cancel';
export const CONFIRM_PARENT_ORG_IMG = 'parent_org';
export const CONFIRM_ERROR_ICON = 'highlight_off'; // error